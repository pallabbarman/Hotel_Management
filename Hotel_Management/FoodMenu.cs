...
namespace Hotel_Management
{
    public partial class FoodMenu : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            lat = 350; mocha = 120; espr = 130; vale = 200; cappu = 40; afri = 100; mTea = 30; cTea = 80; //coffee pries
            cCake = 220; rValvet = 350; bFor = 380; bCream = 320; lChoco = 280; kChoco = 250; cheese = 220; rain = 800; //cake prices
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            rtfReceipt.AppendText("-------------------------------------------------------------" + Environment.NewLine);
            rtfReceipt.AppendText("Kacchi Biriyani \t\t\t" + txtLatte.Text + Environment.NewLine);
            rtfReceipt.AppendText("Murag Polao \t\t\t" + txtEspresso.Text + Environment.NewLine);
            rtfReceipt.AppendText("Tehri \t\t\t\t" + txtMocha.Text + Environment.NewLine);
            rtfReceipt.AppendText("Panta Ilish \t\t\t" + txtValeCoffee.Text + Environment.NewLine);
            rtfReceipt.AppendText("Labra \t\t\t\t" + txtCappu.Text + Environment.NewLine);
            rtfReceipt.AppendText("Fish and Rice \t\t\t" + txtAfricanCoffee.Text + Environment.NewLine);
            rtfReceipt.AppendText("Water \t\t\t\t" + txtMilkTea.Text + Environment.NewLine);
            rtfReceipt.AppendText("Coffee \t\t\t\t" + txtChineseTea.Text + Environment.NewLine);
            rtfReceipt.AppendText("Sweet \t\t\t\t" + txtCoffeCake.Text + Environment.NewLine);
            ...
            rtfReceipt.AppendText("Roshgulla \t\t\t" + txtKillburnChoco.Text + Environment.NewLine);
